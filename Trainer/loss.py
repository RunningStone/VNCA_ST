...
def iwae(x: torch.Tensor, p_x_given_z: Distribution, q_z_given_x: Distribution, p_z: Distribution, z: torch.Tensor):
    """
    ...
    logpx = (torch.logsumexp(logpx_given_z + logpz - logqz_given_x, dim=1) - torch.log(torch.scalar_tensor(z.shape[1])))

    return -logpx, None, None


def elbo(x: torch.Tensor, p_x_given_z: Distribution, q_z_given_x: Distribution, p_z: Distribution, z: torch.Tensor):
    """
